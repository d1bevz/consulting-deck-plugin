...
def create_stakeholder_quotes(data, title=None, theme_path=None, output_path=None):
    ...
    annotations.append({"x": 0.22, "y": 0.88, "text": f"<b>{pro_header}</b>",
        "font": {"size": 24, "color": colors["success"]},
        "xref": "paper", "yref": "paper", "showarrow": False})
    annotations.append({"x": 0.72, "y": 0.88, "text": f"<b>{contra_header}</b>",
        "font": {"size": 24, "color": colors["danger"]},
        "xref": "paper", "yref": "paper", "showarrow": False})

    # Pro quotes — numbered, styled quotation marks, more spacing
    quote_spacing = 0.22
    for i, q in enumerate(data["pro"]):
        y_pos = 0.76 - i * quote_spacing
        annotations.append({"x": 0.03, "y": y_pos,
            "text": f'<b>{i + 1}.</b>  \u00ab{q["quote"]}\u00bb',
            "font": {"size": 18, "color": colors["text"]},
            "xref": "paper", "yref": "paper", "showarrow": False, "xanchor": "left"})
        annotations.append({"x": 0.06, "y": y_pos - 0.06,
            "text": f"\u2014 {q['source']}",
            "font": {"size": 14, "color": colors["muted"]},
            "xref": "paper", "yref": "paper", "showarrow": False, "xanchor": "left"})

    # Contra quotes — numbered, styled quotation marks, more spacing
    for i, q in enumerate(data["contra"]):
        y_pos = 0.76 - i * quote_spacing
        annotations.append({"x": 0.53, "y": y_pos,
            "text": f'<b>{i + 1}.</b>  \u00ab{q["quote"]}\u00bb',
            "font": {"size": 18, "color": colors["text"]},
            "xref": "paper", "yref": "paper", "showarrow": False, "xanchor": "left"})
        annotations.append({"x": 0.56, "y": y_pos - 0.06,
            "text": f"\u2014 {q['source']}",
            "font": {"size": 14, "color": colors["muted"]},
            "xref": "paper", "yref": "paper", "showarrow": False, "xanchor": "left"})

    # Divider line between pro and contra columns
    fig.add_shape(type="line", x0=0.5, x1=0.5, y0=0.10, y1=0.9,
        xref="paper", yref="paper", line={"color": colors["muted"], "width": 1, "dash": "dot"})

    # Summary box — more prominent: larger text, bolder border, more padding
    if data.get("summary"):
        annotations.append({"x": 0.5, "y": 0.04, "text": f"<b>{data['summary']}</b>",
            "font": {"size": 16, "color": colors["text"]},
            "xref": "paper", "yref": "paper", "showarrow": False,
            "bgcolor": "#f0f0f0", "bordercolor": colors.get("primary", colors["muted"]),
            "borderpad": 18, "borderwidth": 2})
    ...
    # Use full slide width — reduce side margins
    layout["margin"] = {"l": 40, "r": 40, "t": 100, "b": 80}
